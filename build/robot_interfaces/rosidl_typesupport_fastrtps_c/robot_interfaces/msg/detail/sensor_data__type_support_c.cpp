...
#include "robot_interfaces/msg/detail/sensor_data__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // temperature_labels
#include "rosidl_runtime_c/string_functions.h"  // temperature_labels
...
using _SensorData__ros_msg_type = robot_interfaces__msg__SensorData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: ultrasonic_distance
  {
    cdr << ros_message->ultrasonic_distance;
  }

  // Field name: ultrasonic_valid
  {
  ...
  // Field name: temperature_labels
  {
    size_t size = ros_message->temperature_labels.size;
    auto array_ptr = ros_message->temperature_labels.data;
    cdr << static_cast<uint32_t>(size);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: temperature_labels
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->temperature_labels.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->temperature_labels);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->temperature_labels, size)) {
      fprintf(stderr, "failed to create array for field 'temperature_labels'");
      return false;
    }
    auto array_ptr = ros_message->temperature_labels.data;
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'temperature_labels'\n");
        return false;
      }
    }
  }
...
static uint32_t _SensorData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__msg__SensorData(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces__msg__SensorData;
    is_plain =
      (
...
static size_t _SensorData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces__msg__SensorData(
