...
bool robot_interfaces__srv__set_mode__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.srv._set_mode.SetMode_Request", full_classname_dest, 46) == 0);
  }
  robot_interfaces__srv__SetMode_Request * ros_message = _ros_message;
  {  // requested_mode
...
PyObject * robot_interfaces__srv__set_mode__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.srv._set_mode");
...
ROSIDL_GENERATOR_C_EXPORT
bool robot_interfaces__srv__set_mode__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.srv._set_mode.SetMode_Response", full_classname_dest, 47) == 0);
  }
  robot_interfaces__srv__SetMode_Response * ros_message = _ros_message;
  {  // success
