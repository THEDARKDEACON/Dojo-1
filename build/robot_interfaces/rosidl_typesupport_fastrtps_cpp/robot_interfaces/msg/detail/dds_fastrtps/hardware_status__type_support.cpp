...
#include "robot_interfaces/msg/detail/hardware_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_interfaces::msg::HardwareStatus & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: data_keys
  {
    cdr << ros_message.data_keys;
  }
  // Member: data_values
  {
    cdr << ros_message.data_values;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::msg::HardwareStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: data_keys
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.data_keys[index].size() + 1);
    }
  }
  // Member: data_values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.data_values[index].size() + 1);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces::msg::HardwareStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_HardwareStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, HardwareStatus)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_HardwareStatus__handle;
}
